...
use Ppa\PaloBundle\Entity\Categoria;
use Ppa\PaloBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PpaPaloBundle:Categoria')->findAll();

        return $this->render('PpaPaloBundle:Categoria:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PpaPaloBundle:Categoria:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Categoria $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Crear', 'attr' => array('class' => 'btn btn-success', 'style' => 'margin-left:12px;')));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PpaPaloBundle:Categoria')->find($id);
        ...
        return $this->render('PpaPaloBundle:Categoria:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PpaPaloBundle:Categoria:edit.html.twig', array(
            'entity'      => $entity,
